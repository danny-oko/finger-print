...
const mn: Translations = {
  ...
  identity: {
    ...
    main: "Хурууны хээ конферренц нь өсвөр үеийг өөрийн үнэ цэнэ болон Эзэний дотор онцгой бүтээл гэдгээ ухаарч Христ итгэлийн амьдралаар амьдрахад нь “Өсвөрийн чуулганууд”-тай хамтран дэмжлэг үзүүлэх зорилготой.",
    clarify:
