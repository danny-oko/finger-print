...
const mn: Translations = {
  ...
  identity: {
    label: "Бидний үнэлэмж",
    main:
      "Finger Print нь Монголын Шүүгчдийн сүмүүдийн залуучуудын үйлчилгээг дэмжиж, холбож, залуучууд Христод өөрийн өвөрмөц үнэлэмж, Бурханаас өгсөн үнэ цэнийг танин мэдэхэд нь шүүглэл, хөгжил, нийгэмлэгийн нэгдсэн орон зайгаар туслана.",
    clarify:
  ...
  journey: {
    ...
    title5: "5-р удаа",
    summary1:
      "Шүүгчдийн сүмүүдийн залуучуудын үйлчилгээний сүлжээний эхлэл.",
    summary2:
  ...
  slides: {
    ...
    slide3Desc:
      '"Finger Print" нь сүмүүдийг Монголын залуучуудыг Христод хамт хүмүүжүүлж, удирдан, дэмжихэд нэгтгэнэ.',
  },
  projects: {
